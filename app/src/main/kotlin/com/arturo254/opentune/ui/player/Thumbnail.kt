...
private object ThumbnailConstants {
    const val CANVAS_DEFAULT_MAX_SIZE = 192  // Reduced from 256 to save RAM
    ...
    const val BLUR_RADIUS = 40f  // Reduced from 60f — same visual effect, less GPU
    ...
    const val ARTWORK_SIZE_TARGET = 720  // 720 is sharp on all phone screens; 1440 wastes memory
}
