...
class CoilBitmapLoader(
    ...
    override fun loadBitmap(uri: Uri): ListenableFuture<Bitmap> =
        scope.future(Dispatchers.IO) {
            ...
            // 96dp is the largest notification icon Android uses. Smaller = less memory + faster decode.
            val maxIconSizePx = (density * 96f).roundToInt().coerceIn(96, 384)
            val attempts = 2  // 3 retries at 250+500ms = 750ms delay; 2 = 250ms max wait
