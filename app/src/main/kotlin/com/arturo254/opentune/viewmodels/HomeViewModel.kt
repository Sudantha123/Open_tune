...
class HomeViewModel @Inject constructor(
    ...
    init {
        viewModelScope.launch(Dispatchers.IO) {
            // Small startup delay: lets ExoPlayer + MusicService initialize first.
            // Without this, home load fires 5+ simultaneous network requests at the same
            // moment the player is resolving the stream URL, causing contention.
