...
class LyricsPreloadManager @Inject constructor(
    ...
    companion object {
        ...
        // Reduced from 3 → 1: preloading 3 songs fires 3 concurrent network requests on every track change.
    // Preloading just the next track is enough; the rest will be fetched lazily.
