...
# ── OpenTune Performance Additions ──────────────────────────────────────────
# Remove all Timber logging in release builds (saves method calls + string allocs)
...
# Optimize: allow R8 to inline and remove unused code paths
